...
const About = () => {
  ...
  return (
    <div id='about' className='min-h-screen w-screen' onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave}>
      <div className='relative mb-9 mt-36 flex flex-col items-center gap-5'>
        ...
        <div className='about-subtext'>
          ...
          <p className='text-gray-500 text-sm'>Zentry unites every player from countless games and platforms, both digital and physical, into a unified Play Economy</p>
        </div>
      </div>

      <div className='h-dvh w-screen' id='clip'>
        <div className='mask-clip-path about-image' ref={frameRef}>
          <img src='img/about.webp' alt='Background' className='absolute left-0 top-0 size-full object-cover object-top' />
        </div>
      </div>
    </div>
  );
