  ...
  return (
    <footer className='w-screen bg-violet-300 py-4 text-black'>
      <div className='container mx-auto flex flex-col items-center justify-between gap-4 px-4 md:flex-row'>
        <p className='text-center text-xs md:text-left'>&copy; Zentry 2024. All rights reserved</p>
        ...
        <a href='#privacy-policy' className='text-black transition-colors duration-500 ease-in-out hover:underline text-xs'>
          Privacy Policy
        </a>
      </div>
      <p className='container mx-auto text-xs text-center md:text-end border-t border-black mt-2 pt-2 md:pl-2'>
        ...
        <a className='underline' href='https://zentry.com' target='_blank' rel='noopener noreferrer'>
          Zentry.com
        </a>{' '}
